package com.smartgrid.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/power/**").authenticated()
                .requestMatchers("/api/faults/**").authenticated()
                .requestMatchers("/api/outages/**").authenticated()
                .requestMatchers("/api/consumers/**").authenticated()
                .requestMatchers("/api/load/**").authenticated()
